...
int main(int argc, char *argv[])
{
  ...
  if(argc!=4)
    {
      printf("emmatlist_griflist_tsns_offset emmaT_list_name grif_list_name map\n");
      exit(-1);
    }
  
 
  printf("Program finds time stamp offset between corresponding fragments in the emmaT and GRIF list.\n");

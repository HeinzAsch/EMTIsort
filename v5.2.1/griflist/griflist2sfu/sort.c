...
int main(int argc, char *argv[])
{
  ...
  if(argc!=4)
    {
      printf("griflist2sfu input_griflist_name output_sfu_name map\n");
      exit(-1);
    }

  printf("For the GRIF data stream program generates a data file in SFU format from an ordered list with trigger numbers.\n");

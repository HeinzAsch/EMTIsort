...
int main(int argc, char *argv[])
{
  ...
  if(argc!=5)
    {
      printf("griflist_apply_trigger griflist_input_data map gate_low[ns] gate_high[ns]\n");
      //printf("griflist_TIP_CC_time_difference griflist_input_data map window_[ns]\n");
      exit(-1);
    }
